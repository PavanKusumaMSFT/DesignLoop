...
const useStyles = makeStyles({
  ...
  iconXxs: { width: "12px", height: "12px", marginLeft: "4px" },
  ...
  // Credits info row
  creditsRow: { display: "flex", justifyContent: "center", marginTop: "16px" },
  // Card description flex
  cardDescFlex: { flex: "1", marginBottom: "16px" },
  // Card button pill
  cardButtonPill: { alignSelf: "flex-start", borderRadius: "20px" },
  // Discover more wrapper
  discoverMoreWrapper: { textAlign: "center", marginTop: "-16px" },
  // Discover more link
  discoverMoreLink: {
    background: "none",
    border: "none",
  ...
  // Search container top margin
  searchContainerMt: { marginTop: "40px" },
  // Input row flex
  inputRowFlex: {
    display: "flex",
  ...
  textareaAutoHeight: { height: "auto", minHeight: "24px" },
  // Vertical divider
  verticalDivider: {
    width: "1px",
    height: "24px",
  ...
  copilotPanelHeaderActions: {
    display: "flex",
    alignItems: "center",
    gap: "8px",
  },
  copilotPanelIconBtn: { minWidth: "32px", height: "32px" },
  copilotPanelCloseBtn: {
    minWidth: "32px",
    height: "32px",
    fontSize: "16px",
    fontWeight: tokens.fontWeightSemibold,
  },
  copilotPanelBody: { flex: "1", padding: "20px", overflowY: "auto" },
  // User message bubble
  userMessageRow: {
    display: "flex",
  ...
  copilotResponseRow: { marginBottom: "20px" },
  copilotResponseMeta: {
    display: "flex",
    alignItems: "center",
    gap: "8px",
  ...
  copilotResponseMetaTitle: {
    fontSize: "14px",
    fontWeight: tokens.fontWeightSemibold,
  },
  copilotResponseMetaDisclaimer: {
    fontSize: "12px",
    color: tokens.colorNeutralForeground3,
  },
  copilotResponseBody: {
  ...
  // Input area (alternate chat input)
  altInputRow: { display: "flex", alignItems: "flex-start", gap: "2px" },
  altInputField: {
    flex: "1",
    border: "none",
    outline: "none",
  ...
  altInputActions: { display: "flex", alignItems: "center", gap: "8px" },
  plusIconMt: { marginTop: "8px" },
  actionCardClickable: {
    cursor: "pointer",
    display: "flex",
    flexDirection: "column",
  ...
  sendBtnActive: { color: tokens.colorBrandForeground1 },
  sendBtnDisabled: { color: tokens.colorNeutralForeground3 },
});
        ...
        {suggestions.length > 0 && (
          <div>
            ...
            {suggestions.slice(0, 4).map((suggestion, index) => (
              ...
              >
                <Search24Regular className={styles.searchIconInline} />
  ...
  const getActionCards = () => {
    const baseCards = [
      ...
      },
      {
        ...
        description:
          "Choose a service to create a resource in your subscription.",
        onClick: () => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <ActionCardGrid
              columns={isCopilotPanelOpen ? 2 : 4}
            ...
            {/* Copilot input bar hidden — search is in the header per Figma spec */}
            {false && (
              <div
                className={mergeClasses(
                  styles.searchContainer,
                  styles.searchContainerMt,
                )}
              >
                {showAttachmentMenu && (
                  <div
                ...
                >
                  {isAgentMode || searchValue.length > 50 ? (
                    <>
                      <div className={styles.inputRowFlex}>
                        <textarea
                          ref={inputRef as any}
                      ...
                      <div className={styles.agentActions}>
                        ...
                        {isAgentMode && (
                          <>
                            ...
                            >
                              ...
                              />
                              <span>Agent</span>
                              <Dismiss16Regular className={styles.iconXxs} />
                            </button>
                          </>
                        )}
                        ...
                        {!isRecording && (
                          ...
                          >
                            ...
                            >
                              <Mic24Regular className={styles.iconSm} />
                            </div>
                          </button>
                        )}
                        {isRecording && (
                        ...
                        {searchValue.trim() && !isRecording && (
                          ...
                          >
                            ...
                            >
                              <ArrowRight24Filled className={styles.iconSm} />
                            </div>
                          </button>
                        )}
                      </div>
                    ...
                    <div className={styles.altInputRow}>
                      <Add24Regular
                        className={mergeClasses(
                          styles.plusIcon,
                          styles.iconSm,
                ...
                {!searchValue && (
                  <HpCopilotSuggestionPanel
                    ...
                    onSetSearchField={(value) => setSearchValue(value)}
          ...
          {isCopilotPanelOpen && (
            <div className={styles.copilotPanel}>
              ...
              <div className={styles.copilotPanelHeader}>
                <Text className={styles.copilotPanelTitle}>Copilot</Text>
                <div className={styles.copilotPanelHeaderActions}>
                  <FluentButton
                    appearance="subtle"
                    icon={<MoreHorizontal24Regular />} // Replaced GridDots24Regular with MoreHorizontal24Regular for ellipsis icon
                    className={styles.copilotPanelIconBtn}
                  />
                  <FluentButton
                    appearance="subtle"
                    onClick={handleCloseCopilotPanel}
                    className={styles.copilotPanelCloseBtn}
                  >
                    ×
                  </FluentButton>
                </div>
              ...
              {/* Chat Content */}
              <div className={styles.copilotPanelBody}>
                {/* User Message */}
                ...
                {/* Copilot Response */}
                <div className={styles.copilotResponseRow}>
                  <div className={styles.copilotResponseMeta}>
                    <CopilotSVGIcon />
                    <Text className={styles.copilotResponseMetaTitle}>
                      Copilot
                    </Text>
                    <Text className={styles.copilotResponseMetaDisclaimer}>
                      AI-generated content may be incorrect
                    </Text>
                  </div>

                  <div className={styles.copilotResponseBody}>
                    <div className={styles.skeletonText100}></div>
                    <div className={styles.skeletonText95}></div>
                    <div className={styles.skeletonText90}></div>
                    <div className={styles.skeletonText85}></div>
                    <div className={styles.skeletonText92}></div>
                    <div className={styles.skeletonText88}></div>
                  </div>
              ...
              {/* Input Area */}
              <div className={styles.copilotPanelFooter}>
                <div className={styles.copilotInputContainer}>
                  <input
                    type="text"
                  ...
                  />
                  <div className={styles.altInputActions}>
                    <Text className={styles.copilotCharCount}>
