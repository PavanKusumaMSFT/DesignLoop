...
const FavItem: React.FC<{
  ...
  return (
    ...
    >
      ...
      >
        <Star20Filled className={styles.starIconYellow} />
      </button>
    </div>
  );
};
    ...
    <div className={styles.microsoftIcon}>
      <div
        className={mergeClasses(
          ...
          styles.microsoftSquareRed,
        )}
      />
      <div
        className={mergeClasses(
          styles.microsoftSquare,
          styles.microsoftSquareGreen,
        )}
      />
      <div
        className={mergeClasses(
          styles.microsoftSquare,
          styles.microsoftSquareBlue,
        )}
      />
      <div
        className={mergeClasses(
          styles.microsoftSquare,
          styles.microsoftSquareYellow,
        )}
      />
    </div>
  );
  ...
  return (
    <>
      ...
      {navMode === "overlay" && isOpen && !disableSoftDismiss && (
        <div className={styles.navOverlay} role="presentation" onClick={onClose} />
      )}
        ...
        className={
          navMode === "docked"
            ? mergeClasses(
                ...
                suppressTransition && styles.navContainerNoTransition,
              )
            : mergeClasses(
                styles.navContainer,
        ...
        <div className={styles.navWrapper}>
          ...
          <div className={styles.navFooter}>
            <div
              ...
              tabIndex={0}
              role="button"
              aria-expanded={openCategories.includes("microsoft-cloud")}
              onClick={() =>
                setOpenCategories((prev) =>
