...
export interface AllServicesCardOption3Props {
  service: Service;
  isFavorited: boolean;
  isHovered: boolean;
  costBasis?: string;
...
/** Option 3 card layout for the All Services page. Based on Option 2 — use this as the starting point for further design exploration. */
export default function AllServicesCardOption3({
  service,
  isFavorited,
  isHovered,
  costBasis,
