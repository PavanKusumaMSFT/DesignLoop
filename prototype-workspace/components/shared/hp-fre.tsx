...
import ActionCard, { ActionCardGrid } from "./action-card";
import {
  Search24Regular,
  Alert24Regular,
  Settings24Regular,
...
import HpCopilotSuggestionPanel from "./hp-copilot-suggestion-panel";
import dynamic from "next/dynamic";

// Lazy load deployment components for better initial load performance
const DeploymentPlan = dynamic(
  () => import("../projects/vnext-agent/deployment-plan"),
  {
    loading: () => null,
  },
);
const DeploymentProgress = dynamic(
  () => import("../projects/vnext-agent/deployment-progress"),
  {
    loading: () => null,
  },
);
const DeploymentComplete = dynamic(
  () => import("../projects/vnext-agent/deployment-complete"),
  {
    loading: () => null,
  },
);
const AgentSummaryPanel = dynamic(
  () => import("../projects/vnext-agent/agent-summary-panel"),
  {
    loading: () => null,
  },
);
const SparkleMenuPanel = dynamic(
  () => import("../projects/vnext-agent/sparkle-menu-panel"),
  {
    loading: () => null,
  },
);
...
const useStyles = makeStyles({
  ...
  panelHeader: {
    ...
    alignItems: "center",
    justifyContent: "space-between",
    padding: `${tokens.spacingVerticalL} 20px`,
    borderBottom: `1px solid ${tokens.colorNeutralStroke2}`,
  },
  panelTitle: {
...
/** Full-page First Run Experience (FRE) landing page for new Azure portal users.
 * Composed from: TopNav, EnhancedInputBar, action cards, deployment flow cards, and copilot panel.
 * Instead of: building a monolithic onboarding page with inline search, cards, and deployment state. */
        ...
        >
          ...
          >
            <div className={styles.header}>
              ...
              <div className={styles.creditsCenterWrapper}>
                ...
                >
                  ...
                  {card.buttonText && (
                    <FluentButton
                      ...
                      className={styles.cardButtonPill}
                    >
                      {card.buttonText}
                    </FluentButton>
                  )}
                ...
                {isAgentMode || searchValue.length > 50 ? (
                  <>
                    ...
                    <div className={styles.agentActions}>
                      ...
                      {isAgentMode && (
                        <>
                          <div className={styles.agentModeDivider} />
                          <button
                  ...
                  <div className={styles.normalModeInputRow}>
                    <Add24Regular
                      className={mergeClasses(
                        styles.plusIcon,
                        styles.plusIconWithOffset,
                      )}
          ...
          {isCopilotPanelOpen && (
            <div className={styles.copilotPanel}>
              ...
              {/* Chat Content */}
              <div className={styles.panelChatContent}>
                {/* User Message */}
                ...
                {/* Copilot Response */}
                <div className={styles.copilotResponseWrapper}>
                  <div className={styles.copilotResponseHeader}>
                    <CopilotSVGIcon />
                    <Text className={styles.copilotResponseName}>Copilot</Text>
                  ...
                  <div className={styles.copilotResponseBody}>
                    <div className={styles.skeletonBodyLineFull}></div>
                    <div className={styles.skeletonBodyLine95}></div>
                    <div className={styles.skeletonBodyLine90}></div>
                    <div className={styles.skeletonBodyLine85}></div>
                    <div className={styles.skeletonBodyLine92}></div>
                    <div className={styles.skeletonBodyLineLast}></div>
                  </div>
