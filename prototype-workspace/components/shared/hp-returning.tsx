...
const useStyles = makeStyles({
  ...
  chevronExpandedTransform: {
    transform: "rotate(0deg)",
  },
  placeholderW60: { width: "60%" },
  placeholderW65: { width: "65%" },
  placeholderW70: { width: "70%" },
  placeholderW75: { width: "75%" },
  placeholderW80: { width: "80%" },
  placeholderW85: { width: "85%" },
  placeholderW90: { width: "90%" },
});
...
/** Personalized landing page for returning Azure portal users with welcome message,
 * credits/billing info, action cards, and expandable recent projects section.
 * Composed from: TopNav, EnhancedInputBar, action cards, skeleton loaders.
 * Instead of: duplicating the FRE page with hardcoded returning-user content. */
const HpReturning: React.FC<HpReturningProps> = ({
  ...
  const placeholderWidthClass: Record<string, string> = {
    "60%": styles.placeholderW60,
    "65%": styles.placeholderW65,
    "70%": styles.placeholderW70,
    "75%": styles.placeholderW75,
    "80%": styles.placeholderW80,
    "85%": styles.placeholderW85,
    "90%": styles.placeholderW90,
  };
            ...
            {actionCards?.map((card, index) => (
              <div
                ...
                className={mergeClasses(
                  styles.actionCard,
                  !card.onClick ? styles.cursorDefault : undefined,
                )}
                ...
                <div className={styles.cardDescription}>
                  <div
                    className={mergeClasses(
                      ...
                      placeholderWidthClass[card.description.width1],
                    )}
                  ></div>
                  {card.description.width2 && (
                    <div
                      className={mergeClasses(
                        ...
                        placeholderWidthClass[card.description.width2],
                      )}
                    ></div>
                  )}
                </div>
              ...
              <div className={styles.cardSubHeaderContainer}>
                ...
                <div className={styles.cardSubHeaderDescription}>
                  <div className={styles.flexOne}>
                    <div className={styles.placeholderBarFull}></div>
                    <div className={styles.placeholderBar70}></div>
                  </div>
              ...
              <table className={styles.resourcesTable}>
                ...
                <tbody>
                  {experienceLevel === "new" ? (
                    <>
                      <tr>
                        <td colSpan={5} className={styles.projectRowCell}>
                          <div className={styles.flexSpaceBetween}>
                            <div
                              className={styles.projectNameClickable}
                              onClick={() => {
                                if (onProjectClick) {
                            ...
                            >
                              <Text
                                weight="semibold"
                                className={styles.brandForegroundText}
                              >
                                MyDemo-Project
                              </Text>
                              <Star16Filled
                                className={styles.brandForegroundIcon}
                              />
                            </div>
                            <ChevronDown24Regular
                              className={mergeClasses(
                                styles.chevronExpander,
                                isProject1Expanded
                                  ? styles.chevronExpandedTransform
                          ...
                          <Text size={200} className={styles.timestampSubtext}>
                      ...
                      {isProject1Expanded && (
                        <>
                          <tr>
                            <td colSpan={5} className={styles.paddingZeroCell}>
                          ...
                          <tr>
                            <td colSpan={5} className={styles.viewAllCell}>
                              <Text size={300} className={styles.viewAllLink}>
                    ...
                    <>
                      ...
                      <tr>
                        <td colSpan={5} className={styles.projectGroupRow}>
                          <div className={styles.flexSpaceBetween}>
                            <div className={styles.projectNameGroup}>
                              ...
                              <Star16Regular
                                className={styles.neutralFg3Icon}
                              />
                            </div>
                            <ChevronDown24Regular
                              className={styles.chevronCollapsed}
                            />
                          </div>
                          <Text size={200} className={styles.timestampSubtext}>
